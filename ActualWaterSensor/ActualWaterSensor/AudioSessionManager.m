...
+ (void)setAudioSessionCategory: (NSString *)categoryConstant
{
    ...
    BOOL success = [audioSession setCategory:categoryConstant withOptions:AVAudioSessionCategoryOptionMixWithOthers|AVAudioSessionCategoryOptionDefaultToSpeaker  error:&setCategoryError];
